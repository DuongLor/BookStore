        ...
        <div class="row">
                            ...
                            @if (!empty(session('cart')))
                                ...
                                @foreach (session('cart') as $key => $item)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item['title'] }}</td>
                                        <td> <img src="{{ asset($item['image']) }}" alt="{{ $item['title'] }}" width="100">
                                        </td>
            ...
            <div class="col-md-4">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item d-flex justify-content-between">
                        <a href="@if (!empty(session('cart'))) {{ route('client.order.index') }} @endif" class="btn btn-success">Chuyển sang trang đặt
                            hàng</a>
                    </li>
                </ul>
            </div>
